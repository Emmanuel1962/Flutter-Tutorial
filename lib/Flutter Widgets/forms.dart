...
import 'package:flutter_tutorial/Flutter%20Widgets/dashboard.dart';
...
class _FormsState extends State<Forms> {
  GlobalKey<FormState> authKey =
      GlobalKey<FormState>(); // this is used to validate your form.
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                TextFormField(
                  controller:
                      usernameCtrl, // The controller stores the information(username) in this field
                ...
                TextFormField(
                  ...
                  obscureText:
                      !showPassword, // this doesnt allow you to see the text you are writing
                  decoration: InputDecoration(
